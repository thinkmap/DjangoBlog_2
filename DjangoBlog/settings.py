...
SECRET_KEY = '&jj-)!!0k3dsjyipr#4xzm%h4*mrbu7k71=nikeo5!19$r!ttd'
...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['*', 'www.thinkmap.top', '127.0.0.1', 'example.com']
...
OAHUTH = {
    'github': {
        'appkey': '2856d6658765e997a53f',
        'appsecret': 'f62a2ae23e00b0e15e2d4c8d2f938f22674ee0fd',
        'callbackurl': 'http://www.thinkmap.top/oauth/authorize?type=github'
    }
}
...
EMAIL_HOST = 'smtp.163.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = 'oolpower@163.com'
EMAIL_HOST_PASSWORD = 'BaijuOOL2018'
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
SERVER_EMAIL = 'oolpower@163.com'

# 设置debug=false 未处理异常邮件通知
ADMINS = [('oolpower', 'oolpower@163.com')]
# 微信管理员密码(两次md5获得)
